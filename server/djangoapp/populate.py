...
def initiate():
    ...
    # Car model data with correct CarMake associations
    car_model_data = [
    ...
    # Create CarModel instances with the associated CarMake
...
# Run initiate() again after making sure it's loaded properly.
